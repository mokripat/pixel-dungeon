...
public class Ballistica {
    ...
    public static boolean canHitChar(int initPos, int charPost) {
        return cast(initPos, charPost, false, true) == charPost;
    }

    public static boolean canAttack(Char enemy) {
        for (int i = 1; i < distance; i++) {
            if (trace[i] == enemy.pos) {
                return true;
            }
        }
        return false;
