...
public class CityBossLevel extends Level {
	...
	private class TileManager {
		public String tileName( int tile, String defaultTileName) {
			switch (tile) {
				case Terrain.WATER:
		...
		public String tileDesc(int tile, String defaultTileDesc) {
			switch (tile) {
	...
	public String tileName( int tile ) {
		return tileManager.tileName(tile, super.tileName(tile));
	}

	@Override
	public String tileDesc(int tile) {
		return tileManager.tileDesc(tile, super.tileDesc(tile));
	}
